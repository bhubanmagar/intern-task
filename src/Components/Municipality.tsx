...
interface MunicipalitySelectorProps extends ControllerRenderProps {
...
const MunicipalitySelector: React.FC<MunicipalitySelectorProps> = ({
  ...
  return (
    <div className="w-full max-w-xs mx-auto">
      {/* Label */}
      <label htmlFor="municipality" className="font-bold ml-4">
        Municipality/Local
      </label>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-y-0 right-16 flex items-center pr-2 pointer-events-none">
          <svg
